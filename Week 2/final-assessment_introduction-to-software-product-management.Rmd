...
`r if(!knitr::is_html_output()) {"* &#x1F30E; Rpubs: [Interactive Document](https://rpubs.com/AndersonUyekita/final-assessment_introduction-to-software-product-management)"}else{"* &#x1F4E6; Github Repository: [Static Document](https://github.com/AndersonUyekita/introduction-to-software-product-management/blob/main/Week%202/final-assessment_introduction-to-software-product-management.md){target='_blank' rel='noopener'}"}`
